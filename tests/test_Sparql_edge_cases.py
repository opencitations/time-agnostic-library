...
class TestSparqlEdgeCases:
    def setup_method(self):
        ...
        self.test_jsonld_data = {
            ...
            "@graph": [
                {"@id": "ex:person1", "@type": "foaf:Person", "foaf:name": "John Doe"}
            ],
        }

    def teardown_method(self):
        Path(self.test_zip_path).unlink(missing_ok=True)
    ...
    def test_select_query_with_language_tagged_literals(self):
        ...
        with Path(temp_jsonld_path).open("w") as f:
        ...
        try:
            ...
            Path(temp_jsonld_path).unlink(missing_ok=True)
    ...
    def test_select_query_with_unknown_value_type(self):
        ...
        jsonld_complex = {
            ...
            "@graph": [
                {"@id": "_:blank1", "@type": "foaf:Person", "foaf:name": "Anonymous"}
            ],
        }
    ...
    def test_get_tuples_set_mixed_values(self):
        ...
        Sparql._get_tuples_set(
            {"x": "plain_string", "y": {"value": "dict_val"}}, output, ["x", "y", "z"]
        )
    ...
    def test_run_select_to_quad_set_skips_missing_var(self, mock_query):
        mock_query.return_value = {
            ...
            "results": {
                "bindings": [
                    {
                        "s": {"type": "uri", "value": "http://ex.com/s"},
                        "p": {"type": "uri", "value": "http://ex.com/p"},
                    },
                    {
                        "s": {"type": "uri", "value": "http://ex.com/s"},
                        "p": {"type": "uri", "value": "http://ex.com/p"},
                        "o": {"type": "literal", "value": "val"},
                    },
                ]
            },
        }
