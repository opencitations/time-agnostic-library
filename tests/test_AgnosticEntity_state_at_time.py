...
class TestAgnosticEntityStateAtTime:
    def test_get_state_at_time_and_related_entities_with_metadata(self):
        ...
        output = AgnosticEntity(
            ...
            time=("2021-05-07T09:59:15+00:00", "2021-05-07T09:59:15+00:00"),
    ...
    def test_get_state_at_time_no_hooks(self):
        ...
        output = AgnosticEntity(input_1, config=CONFIG).get_state_at_time(
            input_2, include_prov_metadata=False
        )
        output_0 = {}
    ...
    def test_get_state_before_time_with_hooks(self):
        ...
        output = AgnosticEntity(input_1, config=CONFIG).get_state_at_time(
            input_2, include_prov_metadata=True
        )
        output_0 = {}
        for timestamp, cg in output[0].items():
            output_0[timestamp] = _to_nt_sorted_list(cg)
