...
def generate_config_file(
    ...
    dataset_urls: list | None = None,
    dataset_dirs: list | None = None,
    *,
    dataset_is_quadstore: bool = True,
    provenance_urls: list | None = None,
    provenance_dirs: list | None = None,
    provenance_is_quadstore: bool = True,
    blazegraph_full_text_search: bool = False,
...
def convert_to_datetime(
    time_string: str | None, *, stringify: bool = False
) -> datetime | str | None:
